...
public class UtilPropShopping {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\bhimm\\Documents\\SE Tomcat and Eclipse\\shoppingGit\\shoppinglist\\WebContent\\config.properties";
